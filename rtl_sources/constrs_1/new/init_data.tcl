# set list_files 
set file_path "/home/eightpins/RANC/mem"
set num_cores 5
...
for {set current_core 0} {$current_core < $num_cores} {incr current_core} {
        ...
        set neuron_con_file [open "${file_path}/core_${format_cur_core}_synap_con.mem" w]
        ...
        puts "Open file to write synapse connection: ${file_path}/core_${format_cur_core}_synap_con.mem" 
        # code here
        ...
        puts "Done reading from filed: ${file_path}/neuron_param${format_cur_core}.mem"
        close $neuron_con_file
